...
public class Model {
    ...
    ObservableList<EllipseInstruction> getEllipseList() {
        return ellipses;
    }

    ObservableList<LineInstruction> getLineList() {
        return lines;
    }

    ObservableList<PlotInstruction> getPlotList() {
        return plots;
    }

    ObservableList<PolygonInstruction> getPolygonList() {
        return polygons;
    }

    ObservableList<RectangleInstruction> getRectangleList() {
        return rectangles;
    }

    public final EllipseInstruction getCurrentEllipse() {
        return currentEllipse.get();
    }

    public final LineInstruction getCurrentLine() {
        return currentLine.get();
    }

    public final PlotInstruction getCurrentPlot() {
        return currentPlot.get();
    }

    public final PolygonInstruction getCurrentPolygon() {
        return currentPolygon.get();
    }

    public final RectangleInstruction getCurrentRectangle() {
        return currentRectangle.get();
    }

    public final PenInstruction getCurrentPen() {
        return currentPen.get();
    }

    public final FillInstruction getCurrentFill() {
        return currentFill.get();
    }
